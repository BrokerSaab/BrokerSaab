        ...
        {step === 'terms' && (
          <div className="flex flex-col flex-1 overflow-hidden bg-white">
            <div className="flex-1 px-5 py-4 space-y-3">
              ...
              <div className="rounded-xl border border-gray-200 bg-gray-50 overflow-hidden">
                <div className="px-4 py-2.5 bg-amber-50 border-b border-amber-100">
                  <p className="text-xs font-semibold text-amber-800">
                    By using BrokerSaab, you agree to:
                  </p>
                </div>
                <ul className="px-4 py-3 space-y-2.5">
                  {[
                    ...
                    { color: '#3b82f6', icon: FileText,     text: "Independently verify any professional's credentials before acting on their advice." },
              ...
              {/* Checkbox */}
              <label className="flex items-start gap-3 cursor-pointer group" onClick={() => setTcAccepted(p => !p)}>
