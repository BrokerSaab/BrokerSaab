...
const s = StyleSheet.create({
  ...
  heading: { ...Typography.heading, color: Palette.text, marginBottom: 2 },
  sub: { ...Typography.bodySmall, color: Palette.textSecondary, marginBottom: Spacing.xl },
  ...
  textarea: { borderWidth: 1, borderColor: Palette.border, borderRadius: Radius.md, padding: Spacing.md, color: Palette.text, backgroundColor: Palette.surface, height: 120, textAlignVertical: 'top', ...Typography.bodySmall, marginBottom: 4 },
